<?php
/**
 * Helper script to create / populate a dummy Portfolio item with the Vertical Images Gallery (3x2 Grid) layout.
 * 
 * You can execute this by opening it directly in your browser:
 * e.g., http://localhost/raio-verde/wp-content/themes/raio-verde-theme/populate-dummy-vertical.php
 * or http://raio-verde.local/wp-content/themes/raio-verde-theme/populate-dummy-vertical.php
 */

header('Content-Type: text/plain; charset=utf-8');

echo "=========================================================\n";
echo "    RAIO VERDE - POPULATE VERTICAL GALLERY DUMMY ITEM    \n";
echo "=========================================================\n\n";
...
$post_title = 'Florence (Vertical Gallery)';
...
// 3. Populate ACF Fields for Vertical Layout (3x2 Grid)
$vertical_dummy_fields = [
    'portfolio_layout_type'       => 'vertical',
    
    // Top Hero (6 Vertical Images in 3x2 Grid)
    'portfolio_vert_img_1'        => 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800',
    'portfolio_vert_img_2'        => 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=800',
    'portfolio_vert_img_3'        => 'https://images.unsplash.com/photo-1499892477393-f675706cbe6e?w=800',
    'portfolio_vert_img_4'        => 'https://images.unsplash.com/photo-1506012787146-f92b2d7d6d96?w=800',
    'portfolio_vert_img_5'        => 'https://images.unsplash.com/photo-1501602758156-fb91b9201a4e?w=800',
    'portfolio_vert_img_6'        => 'https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=800',
    
    // Project Info
    'portfolio_subtitle_1'        => 'Um Subtítulo',
    'portfolio_subtitle_2'        => 'de exemplo',
    'portfolio_description'       => 'Este é um projeto em formato vertical images gallery com grelha 3x2 de alta resolução, seguido de metadados de créditos e módulo triplo com vídeo.',
...
foreach ( $vertical_dummy_fields as $key => $value ) {
...
echo "✓ Successfully set all ACF fields for Vertical Gallery on Post ID: {$post_id}\n";
